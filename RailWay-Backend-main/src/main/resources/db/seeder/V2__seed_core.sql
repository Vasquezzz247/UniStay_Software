...
-- (Opcional) un room/post de ejemplo mínimo
INSERT INTO public.rooms (id, description, address, available, user_id, bathroom_type, is_furnished, kitchen_type, square_footage)
VALUES ('a6c7c698-d75c-44fc-be8a-c69a4749fcef','Habitación individual amueblada','Calle Principal 123', true,
        'e03cb4a6-6ee9-4c89-b1ce-0ae588c8d559','Compartido',true,'Compartida',16)
    ON CONFLICT (id) DO NOTHING;

INSERT INTO public.posts (id, title, price, status, user_id, room_id, maximum_lease_term, minimum_lease_term, security_deposit)
VALUES ('ca57e06d-2038-405c-bb28-b46aeed72985','Habitación acogedora para estudiantes',200,'DISPONIBLE',
        'e03cb4a6-6ee9-4c89-b1ce-0ae588c8d559','a6c7c698-d75c-44fc-be8a-c69a4749fcef','6 meses','4 meses',100)
    ON CONFLICT (id) DO NOTHING;